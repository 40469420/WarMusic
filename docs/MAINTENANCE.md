...
- **Every public build:** run a clean Windows 11 launch, storage-mode check, and the short hardware preflight (`--route-smoke` plus the device suite in `docs/HARDWARE-TESTING.md`).
- **Before calling a build fully qualified:** complete the eight-hour soak and full recovery matrix.
